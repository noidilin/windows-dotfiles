...
local colors = {
   date_fg = '#b3b3b3',      -- #fab387
   date_bg = '#303030',      -- rgba(0, 0, 0, 0.4)
   battery_fg = '#b3b3b3',   -- #f9e2af
   battery_bg = '#303030',   -- rgba(0, 0, 0, 0.4)
   separator_fg = '#8e8e8e', -- #74c7ec
   separator_bg = '#303030', -- rgba(0, 0, 0, 0.4)
}
